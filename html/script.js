$(document).ready(function () {
  ...
  AlcoholIndicator = new ProgressBar.Circle("#AlcoholIndicator", {
    color: "rgb(180, 80, 220)",
    trailColor: "rgb(90, 30, 120)",
    strokeWidth: 10,
    trailWidth: 10,
    duration: 250,
    easing: "easeInOut",
  });
  AlcoholIndicator.animate(0);
});
...
window.addEventListener("message", function (event) {
  ...
  if (data.action == "update_hud") {
    ...
    AlcoholIndicator.animate(data.alcohol / 100);
  }
  ...
  if (data.alcohol == 0) {
    $("#AlcoholIndicator").fadeOut();
  } else if (data.alcohol > 0) {
    $("#AlcoholIndicator").fadeIn();
  }
